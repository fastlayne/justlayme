 ...
 * Handles multiple formats: JSON, CSV, plain text
 */
 ...
 */
export function parseConversationData(data, format = 'paste') {
  try {
    // Validate input
    if (!data) {
    ...
    // This ensures the UI can show a graceful error instead of crashing
    return []
  }
}
...
function normalizeMessages(messages) {
  ...
  if (hasExplicitDirection) {
    // Find a message with direction 'sent' and use that sender as 'You'

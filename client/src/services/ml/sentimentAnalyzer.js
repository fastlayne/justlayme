...
const POSITIVE_KEYWORDS = {
  ...
  weak: [
    ...
    'chill', 'solid', 'reasonable', 'manageable'
  ]
}
...
const NEGATIVE_KEYWORDS = {
  ...
  moderate: [
    ...
    // Modern slang
    'sus', 'sketchy', 'weird', 'off', 'uncomfortable'
  ],
  weak: [
    'meh', 'eh', 'hmm', 'nah', 'nope', 'kinda bad', 'not great',
    'could be better', 'idk', 'unsure', 'uncertain'
  ]
}
...
function calculateEmotionalIntensity(sentiments) {
  ...
  const maxIntensity = Math.max(...scores)

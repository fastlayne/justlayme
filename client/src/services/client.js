...
/**
 * Request Interceptor
 * - Adds auth token to all requests (for backward compatibility)
 * - SECURITY NOTE: Token is primarily sent via httpOnly cookie
 * - Authorization header is kept for transition period only
 */
apiClient.interceptors.request.use(
  (config) => {
    // Keep Authorization header for backward compatibility during transition
    // Eventually this can be removed once all clients use cookie-based auth

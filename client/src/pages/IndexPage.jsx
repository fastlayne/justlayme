...
export default function IndexPage() {
  ...
  return (
    <div className="index-page">
      <Helmet>
        <title>JustLayMe - The Grey Mirror | AI-Powered Self-Reflection & Analysis</title>
        <meta name="description" content="Upload your conversations and watch The Grey Mirror reveal hidden patterns, expose uncomfortable truths, and show you exactly who you are through revolutionary AI analysis." />
        <link rel="canonical" href="https://justlay.me/" />
        <meta property="og:title" content="JustLayMe - The Grey Mirror | AI-Powered Self-Reflection & Analysis" />
        <meta property="og:description" content="Upload your conversations and watch The Grey Mirror reveal hidden patterns, expose uncomfortable truths, and show you exactly who you are through revolutionary AI analysis." />
        ...
        <meta name="twitter:title" content="JustLayMe - The Grey Mirror | AI-Powered Self-Reflection & Analysis" />
        <meta name="twitter:description" content="Upload your conversations and watch The Grey Mirror reveal hidden patterns, expose uncomfortable truths, and show you exactly who you are through revolutionary AI analysis." />
        ...
        <div className="container">
          ...
          <div className="navbar-mobile">
            <Magnet padding={40} magnetStrength={2}>
              <button className="btn-nav mobile-signup" onClick={handleSignUp}>Sign Up</button>
            </Magnet>
            <Magnet padding={40} magnetStrength={2}>
      ...
      <main>
        ...
        <div className="container hero-container">
          <div className="hero-left">
            <h1><ShinyText speed={5}>The Grey Mirror: See Yourself Clearly</ShinyText></h1>
            <p className="hero-subtitle">
              <ShinyText speed={4}>Upload your conversations. Watch AI reveal hidden patterns, expose uncomfortable truths, and show you exactly who you are.</ShinyText>
            </p>
            <p className="hero-technical-details" style={{
              fontSize: '0.85rem',
              opacity: 0.85,
              marginTop: '1rem',
              lineHeight: '1.6',
              ...
              Upload years of text messages and leverage advanced ML classifiers with unlimited context to analyze <strong>7+ comprehensive relationship metrics</strong> including who apologizes more, who double-texts, sentiment patterns, toxicity levels, and emotional engagement. These hard numbers are then synthesized by cutting-edge AI to deliver the most accurate relationship analysis available on the internet.
            </p>
            ...
            <p className="hero-hint">Sign up to start analyzing your relationships with The Grey Mirror</p>
      ...
      <section className="cta">
        <RevealContainer variant="emerge" delay={0}>
          <div className="container">
            ...
            <p><ShinyText speed={4}>Join thousands discovering what The Grey Mirror reveals about them</ShinyText></p>
            <Magnet padding={100} magnetStrength={2.5}>
              <button className="btn-primary btn-large" onClick={handleCTAClick}>Get Started</button>
            </Magnet>
          </div>
        </RevealContainer>
      </section>
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-col">
              ...
              <p><ShinyText speed={3} className="variant-subtle">AI-powered self-reflection & analysis</ShinyText></p>
            </div>
            <div className="footer-col">
              <h4>Product</h4>
              <ul>

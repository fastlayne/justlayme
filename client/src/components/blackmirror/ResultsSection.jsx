...
export default function ResultsSection({
  ...
  expandedMetrics = [],
  onRestart = () => {},
  // PERSONALIZATION: Extract from results or use defaults
  personalization = null,
}) {
  const [isLLMModalOpen, setIsLLMModalOpen] = useState(false)

  // Get personalization from prop or results object
  const personalData = personalization || results.personalization || {
    userName: 'You',
    contactName: 'Them',
    insightsGoal: ''
  }
